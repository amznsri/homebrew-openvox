...
class Openvox < Formula
  ...
  # The 0.2.16 + zero-sha placeholders are intentional — they make a
  # mistakenly-tapped pre-release formula fail at the download step
  # rather than silently install a broken build.
  url "https://files.pythonhosted.org/packages/source/o/openvox-core/openvox_core-0.2.16.tar.gz"
  version "0.2.16"
  sha256 "bda51e552516d559a6518cdaa753d4f633a75d248586ab7f62e7f848e2f62af8"
