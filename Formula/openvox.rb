...
class Openvox < Formula
  ...
  # The 0.1.8 + zero-sha placeholders are intentional — they make a
  # mistakenly-tapped pre-release formula fail at the download step
  # rather than silently install a broken build.
  url "https://files.pythonhosted.org/packages/source/o/openvox-core/openvox_core-0.1.8.tar.gz"
  sha256 "2eac21ca5489f68855fbebbdcc282064e10d119abbe0e9c04165ae11014c5c91"
  version "0.1.8"
...
class OpenvoxCore < Formula
  include Language::Python::Virtualenv

  desc "Shiny new formula"
  homepage "None"
  url "https://files.pythonhosted.org/packages/ea/27/4e80d8cfd16e1488a53a4dc24b051182636e08d7ce5a0be6d400f9ad8160/openvox_core-0.1.8.tar.gz"
  sha256 "2eac21ca5489f68855fbebbdcc282064e10d119abbe0e9c04165ae11014c5c91"
  ...
  resource "hiredis" do
    url "https://files.pythonhosted.org/packages/97/d6/9bef6dc3052c168c93fbf7e6c0f2b12c45f0f741a2d30fd919096774343a/hiredis-3.3.1.tar.gz"
  ...
  resource "pypdf" do
    url "https://files.pythonhosted.org/packages/54/4d/39e48f5294a5a6bb78313839aae820666c2d30daeadb652ed50bd46cafac/pypdf-6.12.1.tar.gz"
    sha256 "3953a097b9f26d4e0ead5ff95943d9971377557662a91d8872186053cd71d30a"
  end
  ...
  resource "silero-vad" do
    url "https://files.pythonhosted.org/packages/32/d3/e31f526482782764aa4f70e20fd4545cf2e4a81a60b6fb0f089f6d107991/silero_vad-6.2.1.tar.gz"
    sha256 "b23062b0e39fad17b1266fc23c1e7b4290219dbe82ce08510889e32f681f4b3b"
  end
  ...
  resource "twilio" do
    url "https://files.pythonhosted.org/packages/30/af/275130be4783c6e2b2122d3b278b63da0007611d1dc073d6414adcc6be03/twilio-9.10.9.tar.gz"
    sha256 "eb74fc026c85a89372836414f57e262119efaa160b9419cf4d05b59056b8e89d"
  end
